    ...
    <main class="container mx-auto p-4">
        <div class="bg-white p-4 rounded-lg shadow-md">
            <div class="flex items-center mb-4">
                <img src="https://via.assets.so/img.jpg?w=100&h=100&tc=&bg=" alt="User Avatar" class="w-24 h-24 rounded-full">
                <div class="ml-4">
                    <h2 class="text-2xl font-bold">Uživatelské Jméno</h2>
                    <p class="text-gray-600">Bio uživatele...</p>
                    <div class="flex mt-2">
                        <div class="mr-4">
